...
import {STRESS_HEADERS} from "@/util/constants";
import {
    ColumnFiltersState,
    FilterFn,
    flexRender,
...
const columns = Object.keys(STRESS_HEADERS).map((key) => ({
    header: key,
    accessorKey: key,
...
const StressTable = ({stressResults}) => {
            ...
            <div className="flex flex-col w-full">
                <div className="overflow-x-auto flex flex-col gap-2">
                    ...
                    <div className="flex justify-center">
                        ...
                        {table.getRowCount().toLocaleString()} stress results
                    </div>
                </div>
            </div>
        </div>
